...
Since the advent of photography practitioners have been searching for process to maximize the detail in their images.  The photographic image is inherently a limited representation of our visual reality.  Each image sacrifices certain elements to produce a generalized view of the scene. 

Photography in its earliest form was a practice in capturing brightness values.  It's invention in the 1800's as a Black and White medium was our first semi-permanent (all physical prints fade over time) process to capture our visual existence.  Photography democratized the image creation process away from the artist and allows all of us the ability to curate our visual world.   

The digitalization of the image created the opportunity to . .  The discrete nature limits the dynamic range and compresses the visual relationships.
